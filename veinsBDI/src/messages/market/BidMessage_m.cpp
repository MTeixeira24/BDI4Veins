...
Register_Class(BidMessage)

BidMessage::BidMessage(const char *name, short kind) : ::MarketMessage(name,kind)
{
    this->auctionId = 0;
    this->context = 0;
    this->bidValue = 0;
...
BidMessage& BidMessage::operator=(const BidMessage& other)
{
...
void BidMessage::copy(const BidMessage& other)
{
...
void BidMessage::setAuctionId(int auctionId)
{
    this->auctionId = auctionId;
}

int BidMessage::getContext() const
{
    return this->context;
}

void BidMessage::setContext(int context)
{
    this->context = context;
}

int BidMessage::getBidValue() const
{
    return this->bidValue;
}

void BidMessage::setBidValue(int bidValue)
{
    this->bidValue = bidValue;
}

int BidMessage::getWtp() const
{
    return this->wtp;
}
...
class BidMessageDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    BidMessageDescriptor();
    virtual ~BidMessageDescriptor();
...
Register_ClassDescriptor(BidMessageDescriptor)

BidMessageDescriptor::BidMessageDescriptor() : omnetpp::cClassDescriptor("BidMessage", "MarketMessage")
{
    propertynames = nullptr;
}

BidMessageDescriptor::~BidMessageDescriptor()
{
    delete[] propertynames;
}

bool BidMessageDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<BidMessage *>(obj)!=nullptr;
}

const char **BidMessageDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *BidMessageDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *BidMessageDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *BidMessageDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int BidMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *BidMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string BidMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
bool BidMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *BidMessageDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
void *BidMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
