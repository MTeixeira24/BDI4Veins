...
Register_Class(MarketMessage)

MarketMessage::MarketMessage(const char *name, short kind) : ::NegotiationMessage(name,kind)
{
    this->platoonId = 0;
...
MarketMessage& MarketMessage::operator=(const MarketMessage& other)
{
...
void MarketMessage::copy(const MarketMessage& other)
{
...
void MarketMessage::setPlatoonId(int platoonId)
{
    this->platoonId = platoonId;
}

IntSet& MarketMessage::getTargets()
{
    return this->targets;
}

void MarketMessage::setTargets(const IntSet& targets)
{
    this->targets = targets;
}

bool MarketMessage::getForWholePlatoon() const
{
    return this->forWholePlatoon;
}

void MarketMessage::setForWholePlatoon(bool forWholePlatoon)
{
    this->forWholePlatoon = forWholePlatoon;
}

int MarketMessage::getMessageId() const
{
    return this->messageId;
}

void MarketMessage::setMessageId(int messageId)
{
    this->messageId = messageId;
}

int MarketMessage::getReplyMessageId() const
{
...
class MarketMessageDescriptor : public omnetpp::cClassDescriptor
{
  ...
  public:
    MarketMessageDescriptor();
    virtual ~MarketMessageDescriptor();
...
Register_ClassDescriptor(MarketMessageDescriptor)

MarketMessageDescriptor::MarketMessageDescriptor() : omnetpp::cClassDescriptor("MarketMessage", "NegotiationMessage")
{
    propertynames = nullptr;
}

MarketMessageDescriptor::~MarketMessageDescriptor()
{
    delete[] propertynames;
}

bool MarketMessageDescriptor::doesSupport(omnetpp::cObject *obj) const
{
    return dynamic_cast<MarketMessage *>(obj)!=nullptr;
}

const char **MarketMessageDescriptor::getPropertyNames() const
{
    if (!propertynames) {
...
const char *MarketMessageDescriptor::getProperty(const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
...
int MarketMessageDescriptor::findField(const char *fieldName) const
{
    ...
    if (fieldName[0]=='t' && strcmp(fieldName, "targets")==0) return base+1;
...
const char *MarketMessageDescriptor::getFieldTypeString(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *MarketMessageDescriptor::getFieldProperty(int field, const char *propertyname) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
int MarketMessageDescriptor::getFieldArraySize(void *object, int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    MarketMessage *pp = (MarketMessage *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

const char *MarketMessageDescriptor::getFieldDynamicTypeString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
std::string MarketMessageDescriptor::getFieldValueAsString(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        ...
        case 1: {std::stringstream out; out << pp->getTargets(); return out.str();}
...
bool MarketMessageDescriptor::setFieldValueAsString(void *object, int field, int i, const char *value) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
...
const char *MarketMessageDescriptor::getFieldStructName(int field) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    switch (field) {
        case 1: return omnetpp::opp_typename(typeid(IntSet));
        default: return nullptr;
    };
}

void *MarketMessageDescriptor::getFieldStructValuePointer(void *object, int field, int i) const
{
    omnetpp::cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount())
    ...
    MarketMessage *pp = (MarketMessage *)object; (void)pp;
    switch (field) {
        case 1: return (void *)(&pp->getTargets()); break;
        default: return nullptr;
    }
}
