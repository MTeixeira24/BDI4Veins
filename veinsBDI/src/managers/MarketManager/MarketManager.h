...
#ifndef MANAGERS_MARKETMANAGER_MARKETMANAGER_H_
#define MANAGERS_MARKETMANAGER_MARKETMANAGER_H_
...
#include "../../managers/manager/constants/MarketConstants.h"
...
#endif /* MANAGERS_MARKETMANAGER_MARKETMANAGER_H_ */
