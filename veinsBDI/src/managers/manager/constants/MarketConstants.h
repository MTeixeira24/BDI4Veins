...
#ifndef MANAGERS_MANAGER_CONSTANTS_MARKETCONSTANTS_H_
#define MANAGERS_MANAGER_CONSTANTS_MARKETCONSTANTS_H_
...
#endif /* MANAGERS_MANAGER_CONSTANTS_MARKETCONSTANTS_H_ */
