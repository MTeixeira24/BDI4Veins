...
#ifndef MANAGERS_MANAGER_BELIEFMODEL_H_
#define MANAGERS_MANAGER_BELIEFMODEL_H_
...
#include "../../managers/manager/BeliefObject.h"
...
#endif /* MANAGERS_MANAGER_BELIEFMODEL_H_ */
