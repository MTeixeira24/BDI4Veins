 ...
 * publications.tno.nl/publication/100798/tugcwo/islam-2013-realistic.pdf
 *
 */
class NakagamiFadingImproved : public AnalogueModel {

public:
    NakagamiFadingImproved(bool constM, double m, bool debug)
        : constM(constM)
        , m(m)
        , debug(debug)
    {
    ...
    virtual ~NakagamiFadingImproved()
    {
    }
